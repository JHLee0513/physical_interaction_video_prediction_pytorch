...
class Options():
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--height', type=int, default=128, help='height of image')
        self.parser.add_argument('--width', type=int, default=128, help='width of image')
        self.parser.add_argument('--output_dir', default='weights', help='directory for model weight.')
        ...
        self.parser.add_argument('--context_frames', type=int, default=1, help= '# of frames before predictions.')
        ...
        self.parser.add_argument('--schedsamp_k', type=float, default=-1, help='The k hyperparameter for scheduled sampling, -1 for no scheduled sampling.')
